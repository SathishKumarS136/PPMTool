...
public class CustomResponseEntityExceptionHandler extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<?> handleProjectNotFoundException(ProjectNotFoundException exception, WebRequest request) {
		...
		return new ResponseEntity<ProjectNotFoundExceptionResponse>(response, HttpStatus.BAD_REQUEST);
	}
	...
	public final ResponseEntity<?> handleUsernameAlreadyExistsException(UsernameAlreadyExistsException exception, WebRequest request) {
		...
		return new ResponseEntity<UsernameAlreadyExistsResponse>(response, HttpStatus.BAD_REQUEST);
	}
