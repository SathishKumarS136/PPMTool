...
class UpdateProjectTask extends Component {
  ...
  componentDidMount() {
    this.props.getProjectTask(
      ...
      this.props.match.params.project_sequence,
      this.props.history
    );
  }
  ...
  componentWillReceiveProps(nextProps) {
    const projectTask = nextProps.projectTask;
    this.setState({
      id: projectTask.id,
  ...
  render() {
    const { backlog_id } = this.props.match.params;
    const { project_sequence } = this.props.match.params;
          ...
          <div className="row">
            <div className="col-md-8 m-auto">
              ...
              <p className="lead text-center">
                Project Name : {backlog_id} | Project Task ID :{" "}
                {project_sequence}
              </p>
